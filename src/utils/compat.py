...
def print_version_info():
    ...
    if TRANSFORMERS_VERSION >= TRANSFORMERS_4_36:
        ...
        print("    * compute_loss() with num_items_in_batch parameter")
        print("    * training_step() with num_items_in_batch parameter")
        ...
        print("    * compute_loss() without num_items_in_batch parameter")
        print("    * training_step() without num_items_in_batch parameter")
